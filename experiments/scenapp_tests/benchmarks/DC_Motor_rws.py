...
def test_lnn(args):
    ...
    # Define the safe region as the domain minus the unsafe region
    ...
    # Define sets for RWS certificate
    sets = {
        certificate.XD: XD,
        certificate.XI: XI,
        certificate.XS: XS,
    ...
    system.time_horizon = 100  # Set time horizon for RWS
    ...
    opts = [ScenAppConfig(
        ...
        CERTIFICATE=CertificateType.RWS,  # Use RWS certificate
